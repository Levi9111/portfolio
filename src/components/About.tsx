              ...
              <div className="space-y-6 text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                <div className="relative pl-8">
                  ...
                  <p>
                    ...
                    web applications using the MERN stack. My journey began with
                    a fascination for how things work, which naturally led me to
                    programming.
                  </p>
                </div>
                ...
                <div className="relative pl-8">
                  <div
                    className="absolute left-0 top-2 w-3 h-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full animate-pulse"
                  ...
                  <p>
                    ...
                    and creating intuitive user experiences. When I'm not
                ...
                <div className="relative pl-8">
                  <div
                    className="absolute left-0 top-2 w-3 h-3 bg-gradient-to-r from-pink-500 to-red-500 rounded-full animate-pulse"
                  ...
                  <p>
                    ...
                    and exploring the latest in web performance optimization and
            ...
            <div className="space-y-8">
              {skills.map((group, groupIndex) => {
                ...
                return (
                  <div
                    key={group.category}
                    className={`group relative transition-all duration-500 delay-${
                      groupIndex * 100
                    } ${
                      isVisible
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className={`p-3 rounded-xl ${group.bgColor} ${group.borderColor} border backdrop-blur-sm group-hover:scale-110 transition-transform duration-300`}
                      >
                        <IconComponent
                          className={`w-6 h-6 bg-gradient-to-r ${group.color} bg-clip-text text-transparent`}
                        />
                      </div>
                    ...
                    <div className="flex flex-wrap gap-3 ml-12">
                      {group.items.map((skill, skillIndex) => (
                        <span
                          key={skill}
                          ref={(el) =>
                            (skillsRef.current[`${groupIndex}-${skillIndex}`] =
                              el)
                          }
                          ...
                          style={{
                            animationDelay: `${
                              groupIndex * 0.1 + skillIndex * 0.05
                            }s`,
                          }}
                        >
                          <span className="relative z-10">{skill}</span>
                          <div
                            className={`absolute inset-0 bg-gradient-to-r ${group.color} opacity-0 group-hover/skill:opacity-10 transition-opacity duration-300`}
                          />
                          <div
                            className={`absolute inset-0 bg-gradient-to-r ${group.color} opacity-0 group-hover/skill:opacity-20 transition-opacity duration-300 blur-sm`}
                          />
